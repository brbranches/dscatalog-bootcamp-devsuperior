...
public class ProductResourceIT {
	...
	@Test
	public void findaAllDeveRetornarPaginaOrdenadaQuandoOrdenarPorNome() throws Exception {
	...
	@Test
	public void updateDeveRetornarProductDTOQuandoIdExistir() throws Exception {
		...
		ResultActions result = mockMvc.perform(put("/products/{id}", idExistente).content(jsonBody)
